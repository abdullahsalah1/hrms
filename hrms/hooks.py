...
website_route_rules = [
	...
	{"from_route": "/api/finance/summary", "to_route": "api/method/hrms.hrms.api.finance.summary"},
	{"from_route": "/api/finance/trends", "to_route": "api/method/hrms.hrms.api.finance.trends"},
	{"from_route": "/api/finance/pending", "to_route": "api/method/hrms.hrms.api.finance.pending"},
	{"from_route": "/api/finance/by-category", "to_route": "api/method/hrms.hrms.api.finance.by_category"},
]
# Jinja
# ----------
...
doc_events = {
	...
	"Employee Checkin": {
		"after_save": [
			"hrms.hr.doctype.employee_checkin.employee_checkin.test_hook",
			"hrms.hr.doctype.employee_checkin.employee_checkin.after_save_hours_leave"
		]
	},
}
